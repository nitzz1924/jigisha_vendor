...
<div class="position-relative overflow-hidden radial-gradient min-vh-100 w-100">
    <div class="position-relative z-index-5">
        <div class="row">
            <div class="col-xl-7 col-xxl-8" style="background-image: url('{{asset('assets/images/registrationimage.jpg')}}'); background-size: cover; background-position: left;">
            </div>
            <div class="col-xl-5 col-xxl-4">
                <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
                    <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                        ...
                        <div class="mt-3">
                            <h2 class="mb-1 fs-5 fw-bolder text-center">Register Yourself with Jigisha Enterprises</h2>
                            ...
                            <div class="mt-4">
                                <form action="{{ route('user.registeruser') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" placeholder="Enter your Phone Number" class="form-control" id="phonenumber" aria-describedby="emailHelp" name="mobile">
                                    </div>
                                    @error('mobile')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
